...
**11. Свой преобразователь из JSON.**             Реализовать функцию from_json(text), которая
возвращает python-объект соответствующий json-строке. Не использовать
стандартные инструменты работы с JSON. (4 балла)

**12. Синглтон.**         Реализовать шаблон проектирования Singleton, который можно
...
**13. Поддержка параметризованных форматов вывода для класса-логгера.**
...
**14. Метакласс model creator.**      Реализуйте метакласс ModelCreator, позволяющий
...
**15. Юниттесты.**       Использовать любой фреймворк для тестирования (unittest, nose,
...
**16. Реализовать свой устанавливаемый (setup.py)**          пакет со всеми заданиями этой
